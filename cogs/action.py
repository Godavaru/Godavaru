...
class Action:
    ...
    async def cuddle(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="cuddle", filetype="gif"))[0])
    ...
    async def hug(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="hug", filetype="gif"))[0])
    ...
    async def slap(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="slap", filetype="gif"))[0])
    ...
    async def kiss(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="kiss", filetype="gif"))[0])
    ...
    async def pat(self, ctx):
        ...
        if ctx.author in ctx.message.mentions:
            msg = f'***pats you***'
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="pat", filetype="gif"))[0])
    ...
    async def poke(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="poke", filetype="gif"))[0])
    ...
    async def tease(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="teehee", filetype="gif"))[0])
    ...
    async def stare(self, ctx):
        ...
        if ctx.author in ctx.message.mentions:
            msg = f'***stares at you***'
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="stare", filetype="gif"))[0])
    ...
    async def sleep(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="sleepy", filetype="gif"))[0])
    ...
    async def cry(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="cry", filetype="gif"))[0])
    ...
    async def triggered(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="triggered", filetype="gif"))[0])
    ...
    async def think(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="thinking", filetype="gif"))[0])
    ...
    async def blush(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="blush", filetype="gif"))[0])
    ...
    async def smile(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="smile", filetype="gif"))[0])
    ...
    async def shrug(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="shrug", filetype="gif"))[0])
        await ctx.send(content=msg, file=discord.File(img, filename="hug.gif"))
    ...
    async def confused(self, ctx):
        ...
        img = await tools.get(url=(await self.bot.weeb.get_image(imgtype="clagwimoth", filetype="gif"))[0])
        await ctx.send(content=msg, file=discord.File(img, filename="hug.gif"))
